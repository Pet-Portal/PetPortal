                    ...
                    <div className="col-lg-4">
                        <div className="card shadow p-3 mb-5 bg-white" style={{ width: "16rem" }}>
                            ...
                            <div className="card-body">
                                <p className="card-text text-dark"><b>{post.owner?.name}</b></p>
                                <p className="card-text text-dark">{post.owner?.email}</p>
                                <p className="card-text text-dark">{post.owner?.ratings?.rate}</p>
                            </div>
                        </div>
                    </div>

                    <div className="col-lg-8">
                        <img style={{ maxHeight: "25rem", width: "100%" }} className="rounded shadow" src={post.image} alt={post.title} />
                        <h1>{post.title}</h1>
                        ...
                        <p>Location: {post.owner?.location}</p>
